...
public class FuentesListFragment extends ListFragment {
	boolean mDualPane;
	int mCurCheckPosition = 0;
	FuentesAdapter mAdapter;
	...
	public void onActivityCreated(Bundle savedInstanceState) {
		...
		// Populate list
		mAdapter = new FuentesAdapter(this.getActivity());
	...
	public class FuentesAdapter extends BaseAdapter {
		...
		public FuentesAdapter(Context context) {
			mContext = context;
		...
		@Override
		public int getCount() {
			return mFuentes.size();
		}

		@Override
		public Entity getItem(int arg0) {
			return mFuentes.get(arg0);
		}
		...
		public View getView(int position, View convertView, ViewGroup parent) {
			...
			lTitle.setText(item.getString("nombre"));
